...
public class JogoExtensaoCatedralText {
	...
	// teste2
		...
		// teste12
		@Test
		public void finalizarPartidaComcidadeImcompletaComCatedralComMeeple() {
			mockarTiles(tiles, t30, t73, t29);
			Partida partida = jogo.criarPartida(tiles, AMARELO, VERMELHO);
		...
		// teste13
		@Test
		public void finalizarPartidaComcidadeImcompletaSemCatedralComMeeple() {
			mockarTiles(tiles, t30, t01, t29);
			Partida partida = jogo.criarPartida(tiles, AMARELO, VERMELHO);
			...
			verificarRelatorioPartida(partida, "Partida_Finalizada", "AMARELO(4,7); VERMELHO(0,7)");
		}
		// teste14
				@Test
				public void cidadeCompletaComDoisMepplesSemCatedral() {
					mockarTiles(tiles, t30, t51, t29, t52, t53, t28, t01, t27);
					Partida partida = jogo.criarPartida(tiles, AMARELO, VERMELHO);
					...
					girar(partida, 3);
					partida.posicionarTile(t51, NORTE);
					partida.posicionarMeepleCidade(OESTE);
					partida.finalizarTurno();
					...
					partida.posicionarTile(t52, OESTE);
					partida.finalizarTurno();
					
					girar(partida, 1);
					partida.posicionarTile(t52, NORTE);
					partida.posicionarMeepleCidade(LESTE);
					partida.finalizarTurno();
					...
					verificarRelatorioPartida(partida, "Em_Andamento", "AMARELO(12,7); VERMELHO(12,7)");
				}
				// teste15
				@Test
				public void cidadeCompletaComDoisMepplesComCatedral() {
					mockarTiles(tiles, t30, t51, t29, t52, t53, t28, t73, t27);
					Partida partida = jogo.criarPartida(tiles, AMARELO, VERMELHO);
					...
					verificarRelatorioPartida(partida, "Em_Andamento", "AMARELO(15,7); VERMELHO(15,7)");
				}
				// teste16
				@Test
				public void cidadeImcompletaComDoisMepplesComCatedral() {
					mockarTiles(tiles, t30, t51, t29, t52, t53, t28, t73);
					Partida partida = jogo.criarPartida(tiles, AMARELO, VERMELHO);
				...
				// teste17
				@Test
				public void cidadeImcompletaComDoisMepplesSemCatedral() {
					mockarTiles(tiles, t30, t51, t29, t52, t53, t28, t01);
					Partida partida = jogo.criarPartida(tiles, AMARELO, VERMELHO);
					...
					verificarRelatorioPartida(partida, "Partida_Finalizada", "AMARELO(10,7); VERMELHO(10,7)");
				}
